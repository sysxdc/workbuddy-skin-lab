...
test("主 Skill 强制采用 background-v1 且禁止旧组件模板", async () => {
  ...
  for (const phrase of ["$nonelinear-image", "background-v1", "三次单图背景调用", "gpt-image-2", "quality=low", "n=1", "不自动重试", "公开 HTTPS URL", "不作承诺", "127.0.0.1", "outcome_unknown"]) {
